        ...
        <div class="relative">
            <transition name="fade">
                <div v-if="showSocialFab" class="absolute right-0 bottom-0 flex flex-col items-end gap-3">
                    <a v-if="store.facebook_url" :href="store.facebook_url" target="_blank" class="w-11 h-11 rounded-full bg-white/70 backdrop-blur ring-1 ring-rose-500/50 flex items-center justify-center shadow-2xl active:scale-95">
                    ...
                    <a v-if="store.instagram_url" :href="store.instagram_url" target="_blank" class="w-11 h-11 rounded-full bg-white/70 backdrop-blur ring-1 ring-rose-500/50 flex items-center justify-center shadow-2xl active:scale-95">
                    ...
                    <a v-if="store.tiktok_url" :href="store.tiktok_url" target="_blank" class="w-11 h-11 rounded-full bg-white/70 backdrop-blur ring-1 ring-rose-500/50 flex items-center justify-center shadow-2xl active:scale-95">
                    ...
                    <a v-if="store.phone && String(store.phone).replace(/[^0-9]/g,'')" :href="`https://wa.me/${String(store.phone).replace(/[^0-9]/g,'')}`" target="_blank" class="w-11 h-11 rounded-full bg-white/70 backdrop-blur ring-1 ring-rose-500/50 flex items-center justify-center shadow-2xl active:scale-95" title="WhatsApp">
