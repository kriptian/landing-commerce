...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title inertia>{{ config('app.name', 'Digitalsolution') }}</title>
        <link rel="icon" type="image/png" href="/images/digitalsolution-logo.png">

        <!-- Primary Meta Tags -->
        <meta name="title" content="{{ config('app.name', 'Digitalsolution') }}">
        ...
        <meta property="og:title" content="{{ config('app.name', 'Digitalsolution') }}">
        ...
        <meta property="twitter:title" content="{{ config('app.name', 'Digitalsolution') }}">
